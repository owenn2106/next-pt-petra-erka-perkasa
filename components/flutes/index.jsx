...
const Flutes = () => {
  const data = [
    {
      img: "/images/flutes/a-flute.webp",
      title: "A-flute",
      description:
    ...
    {
      img: "/images/flutes/b-flute.webp",
      title: "B-flute",
      description:
    ...
    {
      img: "/images/flutes/c-flute.webp",
      title: "C-flute",
      description:
    ...
    {
      img: "/images/flutes/e-flute.webp",
      title: "E-flute",
      description:
    ...
    {
      img: "/images/flutes/f-flute.webp",
      title: "F-flute",
      description:
